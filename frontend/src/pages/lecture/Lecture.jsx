      ...
      {loading ? (
        ...
        <div className="content">
          <div className="progress-bar">
            <p>Lecture completed: {completedLec} out of {lectLength}</p>
          ...
          <div className="lecture-page">
                ...
                <>
                  {lecture.video ? (
                    <div className="video-container">
                      ...
                      <h3 className="lecture-description">{lecture.description}</h3>
                    </div>
                  ) : (
            ...
            <div className="right">
              {user && user.role === "admin" && (
                <button className="common-btn add-btn" onClick={() => setShow(!show)}>
              ...
              {lectures && lectures.length > 0 ? (
                lectures.map((e, i) => (
                  <div
                    ...
                    key={i}
                    className={`lecture-item ${lecture._id === e._id && "active"}`}
                  >
